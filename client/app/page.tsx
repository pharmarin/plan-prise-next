...
const Index = () => {
  return (
    <div className="flex h-screen items-center bg-gray-200 bg-[url('/public/home-bg.jpg')] bg-cover">
      <div className="container mx-auto flex flex-row overflow-hidden rounded-lg">
