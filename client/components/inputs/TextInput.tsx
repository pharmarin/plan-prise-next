  ...
  return (
    <div className={twMerge("relative", wrapperClassName)}>
      <input
        ...
        id={id}
        className={twMerge(
          "peer block w-full appearance-none rounded-lg border border-gray-300 bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-gray-900 focus:border-emerald-600 focus:outline-none focus:ring-0",
          className
        )}
        placeholder=" "
        {...props}
