...
const Button = styled(ButtonBase, {
  base: tw`inline-flex justify-center rounded-md border border-transparent px-4 py-2 text-base font-medium shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 sm:text-sm text-white items-center disabled:bg-gray-400 disabled:cursor-not-allowed focus:ring-teal-500 transition-colors`,
  variants: {
    color: {
